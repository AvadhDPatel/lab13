...
void apate552_ssajan6() {
  printf("Sera Sajan and Avadh Patel\n");
  printf("We learned that git and GitHub are used by developers to keep track of the constant revisions to your code!\n");
}
